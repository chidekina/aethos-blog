...
translationSlug: 2026-02-20-conheca-aria
draft: false
---
...
I run [Aethos Tech](https://www.aethostech.com.br), where I build micro SaaS products and client projects simultaneously. On any given week I might be pushing a feature on a client's platform, running a CI/CD fix on a different service, and validating a new product idea. The context-switching tax is brutal.
...
*ARIA is not open source yet — it's deeply tied to my specific stack and workflows. But if you're curious about building something similar, I'm happy to talk architecture. Find me on [GitHub](https://github.com/chidekina) or ping me at [aethostech.com.br](https://www.aethostech.com.br).*
